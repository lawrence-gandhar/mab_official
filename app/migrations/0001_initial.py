# Generated by Django 2.2.4 on 2020-04-02 18:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.IntegerField(db_index=True, default=0)),
                ('tax', models.DecimalField(blank=True, db_index=True, decimal_places=2, default=0.0, max_digits=100, null=True)),
                ('gst', models.DecimalField(blank=True, db_index=True, decimal_places=2, default=0.0, max_digits=100, null=True)),
