...
AddressFormset = inlineformset_factory(contacts_model.Contacts, users_model.User_Address_Details, extra = 2,
    ...
    widgets = {
        ...
        'is_billing_address_diff' : CheckboxInput(attrs={'class':'form-control input-sm','style':'width:65%;', 'onclick':'billing_clicked($(this))', 'required':'false'}),
        'is_shipping_address' : CheckboxInput(attrs={'class':'form-control input-sm','style':'width:65%;', 'required':'false'}),
    }
)
