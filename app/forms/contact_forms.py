...
class AddressForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'is_billing_address_diff' : CheckboxInput(attrs={'class':'form-control input-sm','style':'width:40%;'}),
            'is_shipping_address' : CheckboxInput(attrs={'class':'form-control input-sm','style':'width:40%;'}),
        }
...
class EditAddressForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'is_billing_address' : CheckboxInput(attrs={'class':'is_billing_address form-control input-sm','style':'width:50%;', 'required':'false'}),
